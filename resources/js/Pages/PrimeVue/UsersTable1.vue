    ...
    <div>
        <div class="card mb-4">
            ...
            <DataTable
                ...
                dataKey="id" paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown JumpToPageInput"
                removableSort
                showGridlines
                sortMode="multiple"
            ...
            >
                ...
                <Column field="assignedRoles" header="Roles" style="min-width: 8rem">
                    <template #body="slotProps">
                ...
                <Column field="permissionsViaRole.length" header="Permissions Via Role" style="min-width: 8rem"/>
                <Column field="permissionsDirect.length" header="Direct Permissions" style="min-width: 8rem"/>
                <Column field="assignedPermissions.length" header="All Permissions" style="min-width: 8rem"/>
