        ...
        <div class="">
            <Table>
                ...
                <template #default>
                    ...
                    >
                        <TableDataCell class="items-center">{{ user.id }}</TableDataCell>
                        <TableDataCell class="items-center">{{ user.name }}</TableDataCell>
                        <TableDataCell class="items-center">{{ user.email }}</TableDataCell>
                        ...
                        <TableDataCell class="flex space-x-2 items-center">
                            <Link
                                :href="route('users.assignRolePermissionToUser',user.id)"
                                preserve-scroll
