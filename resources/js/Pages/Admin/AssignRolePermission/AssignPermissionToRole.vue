...
<template>
    ...
    <div class="mx-auto py-4">
        <div class="flex justify-between items-baseline">
            <h1 class="text-white">Assign Permission to Role:
    ...
    <div class="mt-4 bg-slate-200 p-4 rounded-lg">
        ...
        <div class="mx-auto p-6 rounded-lg bg-gradient-to-bl from-purple-600 to-amber-200">
            <form @submit.prevent="form.put(route('roles.assignPermissionsToRole',role.id))">
                <div class="flex flex-wrap items-center">
                    <span v-for="permission in permissions">
                        ...
                        >
                        <label :for="role.name+' '+permission.name" class="mr-2 peer-checked/checkbox:text-green-900">{{ permission.name }}</label>
                    </span>
                </div>
