...
const items = ref([
    {
        ...
        items: [
            [
                {
                    items: [
                        {label: 'Features', icon: 'pi pi-list', subtext: 'Subtext of item', route: 'login'},
                        {label: 'Customers', icon: 'pi pi-users', subtext: 'Subtext of item', route: 'dashboard'},
                    ]
                }
            ],
    ...
    },
    {
        ...
        command: () => {
            // Callback to run
            toast.add({severity: 'success', summary: 'Success Message', detail: 'Resources Clicked', life: 3000});
        },
    },
    {
        label: 'Contact',
    ...
    <div class="card w-full">
        <MegaMenu :model="items" class="p-4 bg-surface-0" style="border-radius: 3rem">
            ...
            <template #item="{ item }">
                ...
                <div v-else-if="item.image" class="flex flex-col items-start gap-4 p-2">
