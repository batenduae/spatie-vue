...
<template>
    <Head title="Welcome" />
    <div
        class="w-full mx-auto bg-gray-50 text-black/50 dark:bg-black dark:text-white/50"
    >
        <img
            id="background"
        ...
        />
        <div
            class="relative min-h-screen items-center justify-center selection:bg-[#FF2D20] selection:text-white"
        >
            <div class="relative w-full mx-auto px-6 lg:max-w-7xl">
                <header
