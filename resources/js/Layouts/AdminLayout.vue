...
<template>
    <body class="bg-gray-100 dark:bg-gray-900">
        ...
        <!--    TopBar-->
        <div
            class="ml-auto lg:w-[75%] xl:w-[80%] 2xl:w-[85%] h-screen flex flex-col"
        >
            <div
                class="sticky top-0 z-20 h-16 border-b bg-white dark:bg-gray-800 dark:border-gray-700 lg:py-2.5"
            >
                <div
