...
<template>
    ...
    <aside
        class="fixed top-0 z-10 ml-[-100%] flex h-screen w-full flex-col justify-between border-r
        bg-blue-950 text-white/90  dark:bg-gray-800 dark:border-gray-700 dark:text-white/70
        px-6 pb-3 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]"
    >
        <div>
            <div class="-mx-6 px-6 py-4">Brand Logo</div>
            <ul class="mt-6 space-y-2 tracking-wide">
                ...
                <li v-if="hasPermission(['user.view','user.create','user.edit','user.delete'])">
                    <SideBarLink
                ...
                <li v-if="hasPermission(['role.view','role.create','role.edit','role.delete'])">
                    <SideBarLink
                ...
                <li v-if="hasPermission(['permission.view','permission.create','permission.edit','permission.delete'])">
                    <SideBarLink
                ...
                <li v-if="hasPermission(['post.view','post.create','post.edit','post.delete'])">
                    <SideBarLink
        ...
        >
            ...
            >
                ...
                <span
                    class="group-hover:text-red-700 dark:group-hover:text-red-500"
                >Logout</span
                >
            </Link>
        </div>
        ...
        <!--    TopBar-->
        <div
            class="sticky top-0 z-20 ml-auto lg:w-[75%] xl:w-[80%] 2xl:w-[85%] h-screen flex flex-col
            bg-slate-800 text-white dark:bg-gray-800 dark:text-white/70 dark:border-gray-700"
        >
            <div
                class=" h-16 border-b lg:py-2.5"
            >
                <div
                ...
                >
                    ...
                    >
                        User: {{ $page.props.auth.user.name }}, Email:
            ...
            <div class="flex-1 px-4 pt-6 bg-violet-900 overflow-x-auto text-black dark:text-white/70">
                <slot />
            </div>
        </div>
    </body>
