...
<template>
    <div class="card flex justify-center">
        ...
        <Dialog v-model:visible="visible" pt:mask:class="backdrop-blur-sm" pt:root:class="!border-0 !bg-transparent">
            <template #container="{ closeCallback }">
                <div class="flex flex-col px-8 py-8 gap-6 rounded-2xl"
                    ...
                    <svg class="block mx-auto" fill="none" height="40" viewBox="0 0 35 40" width="35"
                    ...
                    <div class="inline-flex flex-col gap-2">
                        <label class="text-primary-50 font-semibold" for="email">Username/Email</label>
                        <InputText id="email" v-model.trim="form.email"
                                   class="!bg-white/20 !border-0 !p-4 !text-primary-50 w-80"></InputText>
                    </div>
                    <div class="inline-flex flex-col gap-2">
                        <label class="text-primary-50 font-semibold" for="password">Password</label>
                        <InputText id="password" v-model.trim="form.password"
                                   class="!bg-white/20 !border-0 !p-4 !text-primary-50 w-80"
                                   type="password"></InputText>
                    </div>
                    <div class="flex items-center gap-4">
                        <Button class="!p-4 w-full !text-primary-50 !border !border-white/30 hover:!bg-white/10"
                                label="Cancel" text
