...
const handleItemClick = () => {
  const pageName = sidebarStore.page3 === props.item.label ? '' : props.item.label
  sidebarStore.page3= pageName
  ...
  <li v-if="item.permission?hasPermission(item.permission):true">
    ...
    >
      ...
      <svg
        ...
        :class="{ 'rotate-180': sidebarStore.page3 === item.label }"
        width="20"
        height="20"
        viewBox="0 0 20 20"
        fill="none"
...
<!--    <div class="translate transform overflow-hidden" v-show="sidebarStore.page3 === item.label">-->
